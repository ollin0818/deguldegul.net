...
(function () {
  ...
  const tutorialTranslations = {
    ko: {
      steps: [
        ["대전 방식을 선택하세요.", "2P 대전은 같은 화면에서 친구와 겨루고, AI 대전은 혼자 연습하며 난이도별 랭킹에 도전합니다."],
    ...
    en: {
      steps: [
        ["Choose a battle type.", "2P Battle is for same-screen play, and AI Battle is solo practice with difficulty rankings."],
    ...
    ja: {
      steps: [
        ["対戦方式を選んでください。", "2P対戦は同じ画面で対戦し、AI対戦は1人で練習して難易度別ランキングに挑戦できます。"],
    ...
    zh: {
      steps: [
        ["请选择对战方式。", "2P对战适合同屏游玩，AI对战适合单人练习并挑战不同难度排行榜。"],
